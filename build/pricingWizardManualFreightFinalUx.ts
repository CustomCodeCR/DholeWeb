...
function patchWizard(source: string) {
  ...
  // La acción de crear la tarifa manual debe quedar al final de Pantalla 6,
  // después de que el usuario haya completado todos los datos del flete.
  ...
  // En Pantalla 5 se debe distinguir claramente una tarifa creada por el usuario
  // de una tarifa proveniente de correo, PDF, Excel u otra importación automática.
