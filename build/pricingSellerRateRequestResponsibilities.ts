...
function patchWizard(source: string) {
  ...
  const supportCard = `          <div class="crystal-soft space-y-4 p-4 md:p-5">\n            <div>\n              <p class="font-black">Documentos de respaldo de la solicitud</p>`
  ...
  const ratesLoading = `          <div v-if="loadingRates" class="py-14 text-center text-sm font-semibold text-[var(--dh-text-muted)]">Buscando tarifas vigentes…</div>`
