...
<template>
  <aside
    class="fixed bottom-4 left-4 top-4 z-40 overflow-hidden rounded-[34px] border border-[var(--dh-border)] bg-[var(--dh-shell)] shadow-[var(--dh-shadow-lg)] backdrop-blur-2xl transition-[width] duration-300"
    ...
    <div class="border-b border-[var(--dh-border)] p-3">
      ...
      >
        ...
        <div v-if="!collapsed" class="min-w-0">
          <p class="truncate text-sm font-black tracking-tight text-[var(--dh-text)]">Dhole</p>
