...
export const serviceMonitors: ServiceMonitorDefinition[] = [
  ...
  {
    key: 'agent',
    name: 'Dhole Agent Service',
    nameKey: 'monitoring.services.agent.name',
    description: 'Automatización de navieras, sesiones web, programaciones y ejecuciones.',
    descriptionKey: 'monitoring.services.agent.description',
    url: buildGatewayHealthUrl('agent'),
    critical: true,
  },
  {
    key: 'hermes',
    name: 'Hermes Agent',
    nameKey: 'monitoring.services.hermes.name',
    description: 'Motor de automatización web utilizado por Dhole Agent.',
    descriptionKey: 'monitoring.services.hermes.description',
    url: buildGatewayHealthUrl('hermes'),
    critical: false,
  },
  {
    key: 'reports',
