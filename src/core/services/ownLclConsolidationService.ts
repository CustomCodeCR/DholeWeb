...
export function createDefaultOwnLclPricingLines(): OwnLclPricingLineDto[] {
  return [
    ...
    { lineKey: 'CA_TRANSSHIPMENT', scope: 'CA', name: 'Transbordo', chargeBasis: 'CBM', costUnit: 0, saleUnit: 29 },
    { lineKey: 'CA_INLAND_NI', scope: 'CA', name: 'Flete Terrestre · Nicaragua', chargeBasis: 'CBM', costUnit: 0, saleUnit: 40 },
    { lineKey: 'CA_INLAND_HN', scope: 'CA', name: 'Flete Terrestre · Honduras', chargeBasis: 'CBM', costUnit: 0, saleUnit: 50 },
    { lineKey: 'CA_INLAND_GT', scope: 'CA', name: 'Flete Terrestre · Guatemala', chargeBasis: 'CBM', costUnit: 0, saleUnit: 48 },
    { lineKey: 'CA_INLAND_SV', scope: 'CA', name: 'Flete Terrestre · El Salvador', chargeBasis: 'CBM', costUnit: 0, saleUnit: 40 },
    { lineKey: 'CA_STUFFING', scope: 'CA', name: 'Stuffing', chargeBasis: 'CBM', costUnit: 0, saleUnit: 10 },
    { lineKey: 'CA_DOCUMENTATION', scope: 'CA', name: 'Documentación', chargeBasis: 'HBL', costUnit: 0, saleUnit: 140 },
