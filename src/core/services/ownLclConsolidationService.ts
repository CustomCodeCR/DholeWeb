...
export function createDefaultOwnLclPricingLines(matrixType: OwnLclMatrixType = 'China'): OwnLclPricingLineDto[] {
  ...
  return [
    ...
    { lineKey: 'CR_HANDLING', scope: 'CR', name: 'Manejos', chargeBasis: 'HBL', costUnit: 0, saleUnit: 65, calculationBaseCbm: null },
    { lineKey: 'CR_ZONE', scope: 'CR', name: 'Zone Charge', chargeBasis: 'HBL', costUnit: 0, saleUnit: 50, calculationBaseCbm: null },
