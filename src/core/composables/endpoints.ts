...
export const PricingEndpoints = {
  ...
  assignImportRatePoe: {
    method: 'PUT',
    path: '/api/pricing/import-rates/{{importRateId}}/poe',
    headers: jsonHeaders,
  },
  reviewImportRate: {
    method: 'PUT',
    path: '/api/pricing/import-rates/{{importRateId}}/review',
    headers: jsonHeaders,
  },
  rejectImportRates: {
    method: 'POST',
  ...
  browseRateTermItems: {
    method: 'GET',
    path: '/api/pricing/rate-term-items',
    headers: acceptJson,
  },
  createRateTermItem: {
    method: 'POST',
  ...
  updateRateTermItem: {
    method: 'PUT',
    path: '/api/pricing/rate-term-items/{{rateTermItemId}}',
    headers: jsonHeaders,
  },
  setRateTermItemActive: {
    method: 'PATCH',
    path: '/api/pricing/rate-term-items/{{rateTermItemId}}/set-active',
    headers: jsonHeaders,
  },
  deleteRateTermItem: {
    method: 'DELETE',
  ...
  selectRateTermItems: {
    method: 'GET',
    path: '/api/pricing/rate-term-items/select',
    headers: acceptJson,
  },
  browseCarrierFreeDayRules: { method: 'GET', path: '/api/pricing/carrier-free-day-rules', headers: acceptJson },
  resolveCarrierFreeDayRule: { method: 'GET', path: '/api/pricing/carrier-free-day-rules/resolve/{{carrierId}}', headers: acceptJson },
  createCarrierFreeDayRule: { method: 'POST', path: '/api/pricing/carrier-free-day-rules', headers: jsonHeaders },
  updateCarrierFreeDayRule: { method: 'PUT', path: '/api/pricing/carrier-free-day-rules/{{ruleId}}', headers: jsonHeaders },
  deleteCarrierFreeDayRule: { method: 'DELETE', path: '/api/pricing/carrier-free-day-rules/{{ruleId}}', headers: acceptJson },
  browseRateTermBlocks: { method: 'GET', path: '/api/pricing/rate-term-blocks', headers: acceptJson },
  resolveRateTermBlocks: { method: 'GET', path: '/api/pricing/rate-term-blocks/resolve', headers: acceptJson },
  createRateTermBlock: { method: 'POST', path: '/api/pricing/rate-term-blocks', headers: jsonHeaders },
  updateRateTermBlock: { method: 'PUT', path: '/api/pricing/rate-term-blocks/{{blockId}}', headers: jsonHeaders },
...
export const DataExtractionEmailEndpoints = {
  ...
  sendEmailExtractionToPricing: {
    method: 'POST',
    path: '/api/data-extraction/email/extraction-jobs/{{jobId}}/send-to-pricing',
    headers: acceptJson,
  },
...
export const AiEndpoints = {
  ...
  getConnection: {
    method: 'GET',
    path: '/api/ai/connections/{{connectionId}}',
    headers: acceptJson,
  },
  ...
  setConnectionActive: {
    method: 'PATCH',
    path: '/api/ai/connections/{{connectionId}}/active',
    headers: jsonHeaders,
  },
  testConnection: {
    method: 'POST',
    path: '/api/ai/connections/{{connectionId}}/test',
    headers: acceptJson,
  },
  discoverModels: {
    method: 'POST',
    path: '/api/ai/connections/{{connectionId}}/discover-models',
    headers: acceptJson,
  },
  deleteConnection: {
    method: 'DELETE',
  ...
  setModelActive: {
    method: 'PATCH',
    path: '/api/ai/models/{{modelId}}/active',
    headers: jsonHeaders,
  },
  ...
  configureProfileModels: {
    method: 'PUT',
    path: '/api/ai/profiles/{{profileId}}/models',
    headers: jsonHeaders,
  },
  setProfileActive: {
    method: 'PATCH',
    path: '/api/ai/profiles/{{profileId}}/active',
    headers: jsonHeaders,
  },
  ...
  getPromptTemplate: {
    method: 'GET',
    path: '/api/ai/prompt-templates/{{promptTemplateId}}',
    headers: acceptJson,
  },
  ...
  setPromptTemplateActive: {
    method: 'PATCH',
    path: '/api/ai/prompt-templates/{{promptTemplateId}}/active',
    headers: jsonHeaders,
  },
  ...
  executeEmbeddings: {
    method: 'POST',
    path: '/api/ai/executions/embeddings',
    headers: jsonHeaders,
  },
  cancelExecution: {
    method: 'POST',
    path: '/api/ai/executions/{{executionId}}/cancel',
    headers: jsonHeaders,
  },
} satisfies Record<string, Endpoint>
...
export const ReportsEndpoints = {
  ...
  getTemplate: {
    method: 'GET',
    path: '/api/reports/templates/{{templateId}}',
    headers: acceptJson,
  },
...
export const NotificationsEndpoints = {
  ...
  getNotificationMessage: {
    method: 'GET',
    path: '/api/notifications/messages/{{notificationId}}',
    headers: acceptJson,
  },
  ...
  cancelNotificationMessage: {
    method: 'POST',
    path: '/api/notifications/messages/{{notificationId}}/cancel',
    headers: acceptJson,
  },
  notificationHistoryByEntity: {
    method: 'GET',
    path: '/api/notifications/messages/history/entity',
    headers: acceptJson,
  },
  notificationHistoryByRecipient: {
    method: 'GET',
    path: '/api/notifications/messages/history/recipient',
    headers: acceptJson,
  },
  browseNotificationTemplates: {
    method: 'GET',
  ...
  setNotificationTemplateActive: {
    method: 'PATCH',
    path: '/api/notifications/templates/{{templateId}}/active',
    headers: jsonHeaders,
  },
