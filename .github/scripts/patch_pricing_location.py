...
old_location = '''          <div v-if="selectedIncotermCode === 'EXW' || selectedIncotermCode === 'FCA'" class="crystal-soft space-y-4 p-4 md:p-5">
            <div>
...
new_location = '''          <div v-if="selectedIncotermCode === 'EXW' || selectedIncotermCode === 'FCA'" class="crystal-soft space-y-4 p-4 md:p-5">
            <div>
...
replace_once(old_location, new_location, 'screen 3 location UI')
